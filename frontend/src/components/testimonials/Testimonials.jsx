...
const Testimonials = () => {
  const testimonialsData = [
    ...
    },
    {
      ...
      position: "Student",
      message:
        "Of all the courses I've taken to date around web development this one by far is the best. It's the perfect specialization to learn the big 3 front-end coding languages HTML, CSS and JavaScript.",
      image:
